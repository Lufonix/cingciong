...
<?php
    ...
    while($i = mysqli_fetch_row($query1)) {
        echo ("
            ...
            <div class='formularz'>
                <form action='editdescriptionscript.php' method='post'>
                    <p><i>Zmień opis na swoim profilu</i></p>
                        <div class='wpiszopis'>
                            Wpisz nowy opis który będzie się wyświetlał na Twoim profilu:<br><br><br>
                            <textarea name='newdescription' rows='5' cols='30'></textarea><br>
                        </div>      
            <br>
                <div class='przycisk'>    
